<?php
        ...
        $mcImageManagerConfig['general.language'] = "bg"; // en, sv
        ...
        //$mcImageManagerConfig['filesystem.rootpath'] = '/var/www/oblicovki/uploads/images/'; // absolute or relative from this script path, required.
        
        
        $mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
        $mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
        $mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^mcith$|^thumbs$/i';
        ...
        $mcImageManagerConfig['upload.max_width'] = "667"; // Only if force_width_height is true
        $mcImageManagerConfig['upload.max_height'] = "500"; // Only if force_width_height is true
        $mcImageManagerConfig['upload.multiple_upload'] = true;
        $mcImageManagerConfig['upload.chunk_size'] = '1mb';
        $mcImageManagerConfig['upload.format'] = "137x85=thumbs/%f.%e";
